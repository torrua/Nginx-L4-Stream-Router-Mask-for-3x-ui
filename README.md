...
```
> **Что будет сделано:** Включение BBR, отключение IPv6, создание безопасного sudo-пользователя, импорт или генерация SSH-ключей Ed25519, изменение порта SSH, отключение парольного входа по SSH, настройка UFW, установка Fail2ban и развертывание чистой панели 3X-UI v2.9.4.
