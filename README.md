...
Решение полностью оптимизировано под архитектуры **x86_64** и **ARM** (включая **Armbian** на одноплатных компьютерах), настроено на максимальное быстродействие и защищено от активного сетевого сканирования (Active Probing) со стороны систем DPI.
