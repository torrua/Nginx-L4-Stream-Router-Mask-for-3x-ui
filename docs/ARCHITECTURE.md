...
# 🛡️ Техническая архитектура: Hardened VPS & Nginx L4 Stream Router для 3X-UI (v7.1.0)
...
2. [Этап 2: Архитектура маршрутизации Nginx Stream L4/L7 (`setup_mask.sh`)](#2-этап-2-архитектура-маршрутизации-nginx-stream-l4l7-setup_masksh)
   ...
   * [2.7. Подсистема интерактивного мастера и отказоустойчивости (v7.1.0)](#27-подсистема-интерактивного-мастера-и-отказоустойчивости-v710)
...
### 2.7. Подсистема интерактивного мастера и отказоустойчивости (v7.1.0)
